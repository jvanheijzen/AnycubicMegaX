...
#define MSG_MY_VERSION "V1.2.6"//2019.11.5大熊修改
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp   20.0//11.06//9.54 // 8.63// 6//11.96//10// 8.46 //16.43//10//15.67
  #define  DEFAULT_Ki   0.3//1.07// 0.43//0.66  //0.34//0.2 //0.4//0.54// 0.33  // 1.04// 0.54// 0.94
  #define  DEFAULT_Kd   150//71.49//56.81 //55.14// 50//58.49//60.42// 54.45 //61.37//60.42//65.46
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 60 //15.00
  #define  DEFAULT_bedKi 0.3 //0.023
  #define  DEFAULT_bedKd 30//1905.4S
...
#define THERMAL_PROTECTION_BED     // Enable thermal protection for the heated bed  //2019.4.2大熊修改，不保护热床
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT    { 80, 80, 800, 400 }//{ 80, 80, 1600, 403 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE            { 120, 120, 20, 80 }// { 200, 200, 6, 80 }
...
#define DEFAULT_ACCELERATION            400//500//700//600 //500   // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION    3000// 600//700//600  //500  // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION     400//500//700//600  //500  // X, Y, Z acceleration for travel (non printing) moves
...
#define DEFAULT_YJERK                 4//30.0
#define DEFAULT_ZJERK                 0.1
#define DEFAULT_EJERK                 8 //20.0
...
#define INVERT_X_DIR   true//false 2019.4.1大熊修改 调整方向
...
#define X_MIN_POS 0  //之前�?5，现在为了让坐标居中�?  2019.3.30 大熊修改
#define Y_MIN_POS -4.25 //之前�?7，现在为了让模型下来一点，改为-5
#define Z_MIN_POS 0
